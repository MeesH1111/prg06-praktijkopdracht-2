    ...
    return (
        <div className="bg-gradient-to-r from-indigo-500 via-green-500 to-yellow-500 min-h-screen">
            <nav className="flex justify-around items-center p-8 shadow-2xl rounded-lg bg-black bg-opacity-70 backdrop-blur-xl border-4 border-double border-purple-700 transform rotate-2 scale-105">
                <Link className="text-3xl font-extrabold text-white hover:text-red-500 transition-all duration-300 transform hover:skew-y-6 hover:scale-150" to={`/`}>
                    🏠 Home
                </Link>
                <Link className="text-3xl font-extrabold text-white hover:text-green-300 transition-all duration-300 transform hover:skew-x-6 hover:rotate-12" to={`/about`}>
                    🌟 About
                </Link>
                <Link className="text-3xl font-extrabold text-white hover:text-blue-300 transition-all duration-300 transform hover:-rotate-12 hover:scale-150" to={`/decks/create`}>
                    🎴 Create New Deck
                </Link>
